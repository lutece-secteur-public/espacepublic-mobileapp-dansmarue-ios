...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        showOpeningMessage()
        UITabBar.appearance().selectionIndicatorImage = getImageWithColorPosition(color: UIColor.pinkDmr(), size: CGSize(width: (window?.frame.size.width)!/4, height: 49), lineSize: CGSize(width: (window?.frame.size.width)!/2, height: 4))
        return true
    }
    ...
    private func showOpeningMessage() {
        RestApiManager.sharedInstance.getOpeningMessage { messageBO in
            if messageBO != "" {
                ...
                let fermerBtn = UIAlertAction(title: "Fermer", style: .default, handler: { (_: UIAlertAction) in })
        ...
        if let rootView = (window?.rootViewController)!.view {
            ...
            DispatchQueue.main.asyncAfter(deadline: when) {
                ...
                if typeContribution == .outdoor {
                    let anomalie = Anomalie(id: anomalieId, address: "", latitude: 0, longitude: 0, categorieId: "", descriptive: "", priorityId: "", anomalieStatus: .Brouillon, photoCloseUrl: nil, photoFarUrl: nil, photoDoneUrl: nil, number: "", messagesSFGeneric: [(id: String, message: String)](),messagesSFTypologie:[(id: String, message: String)]())
                    
                    NotificationCenter.default.post(name: Notification.Name(rawValue: Constants.NoticationKey.pushNotification), object: anomalie)
                } else {
                    let anomalie = AnomalieEquipement(id: anomalieId, address: "", latitude: 0, longitude: 0, categorieId: "", descriptive: "", priorityId: "", anomalieStatus: .Brouillon, photoCloseUrl: nil, photoFarUrl: nil, photoDoneUrl: nil, number: "", messagesSFGeneric: [(id: String, message: String)](),messagesSFTypologie:[(id: String, message: String)]())
